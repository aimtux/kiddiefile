...
$(document).ready(function() {
    ...
    $('body').on('click', '.action-info', function() {
    	...
    	if (allow_links != '' && data_type != 'dir'){
            ...
            output += '<div class="modal-content"><h5><?php echo lang::get("Audio Link:")?></h5> <textarea readonly> <audio controls><source src="'+data_link+'" type="audio/mpeg"></audio>  </textarea> </div>';
    	}
